 ...
 */
class getPubRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PubRepository' shared autowired service.
     *
     * @return \App\Repository\PubRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PubRepository.php';

        return $container->privates['App\\Repository\\PubRepository'] = new \App\Repository\PubRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
